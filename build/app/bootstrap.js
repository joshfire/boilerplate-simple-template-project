(function() {
  ...
  Joshfire.factory = {
    ...
    config: {"app":{"id":"51d2ed45e3a2930200000017","icon":null,"logo":null,"name":"boilerplate-default-ds","integration":"factory","version":"1.0"},"template":{"name":"sleek","version":"1.3.6","options":{"tabs":["Feed","Youtube"],"color":"gray","language":"auto"},"hooks":["loaded"]}},
    device: {"type":"desktop-web"},
    addons: {}
  };
  Joshfire.factory.config.deploy = {"flags":{"web":true},"type":"tarball","id":"51d42ef75be06b0200000012","env":"live"};
  Joshfire.factory.config.datasources = {"main":[{"name":"Feed","db":"operator","col":"updatelinks","query":{"filter":{"datasources":{"main":{"name":"Feed","id":"51d42efd2d7e1f0200000002","db":"feed","col":"rss","outputType":"BlogPosting","runatclient":false,"runtime":"hosted","apikey":"8waZD/CUThfW+WrCU7iG1hgzq0nu2n4yyUTbwv+7xTlKviH+fbmIKKnkkKF1mBGmjLxPi5QqqsfTFSSkArJQrA=="}},"action":"addtarget"}},"outputType":"BlogPosting","runatclient":true,"runtime":"browser"},{"name":"Youtube","db":"operator","col":"updatelinks","query":{"filter":{"datasources":{"main":{"name":"Youtube","db":"youtube","col":"videos","query":{"filter":{"playlist":"PL71FE81BCCA633E53"}},"runatclient":true,"missingKeys":[],"outputType":"VideoObject","runtime":"browser"}},"action":"addtarget"}},"outputType":"VideoObject","runatclient":true,"runtime":"browser"}]};
  ...
  var collection = function (datasource, atomicCollection) {
    ...
    self.process = function (data, options, callback) {
      self.onLoaded(function () {
        ...
        if (!collectionObject) return callback(new NotFoundError(
        ...
        if (collectionObject.process) {
          ...
          callback(new InternalError(
            'Collection does not have a "process" method.'));
        }
      });
    };
