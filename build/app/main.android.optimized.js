...
(function(J) {
  ...
  J.onReady = function(f) {
    J.require(['joshlib!vendor/zepto'], function($) {
      //      $(f);
      f.call();
    });
  };
...
/**
 * JOSHFIRE: library wrapped in a "define" AMD call, code between
 * "Start almost vanilla" and "End almost vanilla" is almost a
 * vanilla copy of iScroll-lite, except for custom code flagged with
 * "JOSHFIRE".
 *
 * NB: the library exports itself to a global iScroll property.
 */
define('joshfire-framework/vendor/iscroll-lite',[], function() {

// Start almost vanilla iScroll lite
/*!
...
// End vanilla iScroll lite

return window.iScroll;

});
define('joshfire-framework/adapters/android/vendor/iscroll',[
	"joshlib!vendor/underscore",
